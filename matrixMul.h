...
// Half General Szie
// #define WA (32 * BLOCK_SIZE * 0.5)
// #define HA (16 * BLOCK_SIZE * 0.5)
// #define WB (24 * BLOCK_SIZE * 0.5)

// Double General Szie
#define WA (32 * BLOCK_SIZE * 2)
#define HA (16 * BLOCK_SIZE * 2)
#define WB (24 * BLOCK_SIZE * 2)
